        ...
        else
        {
          ...
          if($user)
          {
           ...
           // $password= hash('sha256',$password_1);
            $query = "INSERT INTO user (fname,email,mobile, username,password, role) VALUES('$fname','$email', '$mobile', '$username', '$password_1', '$role')";
                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="fname" minlength="2" maxlength="32" id="fname" placeholder="Enter full name" required />
                            </div>                           

                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
								
                                <input type="email" name="email"  maxlength="50" id="email" placeholder="Your Email iD" required />
                            </div>

                            <div class="form-group">
                                <label for="mobile"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="number" name="mobile" minlength="10" maxlength="10" id="name" placeholder="Enter 10 digit Mobile number" required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_2" id="re_pass" placeholder="Confirm password" minlength="8" maxlength="32" required />
                            </div>
                           <div class="form-group">
                            ...
                            <div class="form-group form-button">
                              <input type="submit" name="reg_user" id="signup" class="example_e" value="Create Account"/>
                            </div>
                          </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="images/signup-image.jpg" alt="sing up image"></figure>
                        <a href="login.php" class="signup-image-link">Have an Account? Log in</a>
                    </div>
                </div>
            </div>
        </section>
